	...
	<div class="game-container">
		...
		<div class="difficulty-selector">
			<button
				...
				on:click={() => initializeGame('beginner')}
			>
				{$t('games.snake.beginner')}
			</button>
			<button
				class:selected={difficulty === 'intermediate'}
				on:click={() => initializeGame('intermediate')}
			>
		...
		<div class="directions">
			...
			<div class="direction-row">
				<button class="direction-button left" on:click={() => handleDirectionButton('LEFT')}
					>⬅️</button
				>
				<button class="direction-button right" on:click={() => handleDirectionButton('RIGHT')}
					>➡️</button
				>
			</div>
			<button class="direction-button down" on:click={() => handleDirectionButton('DOWN')}
				>⬇️</button
			>
		</div>
		...
		<div
			...
			class:expert={difficulty === 'expert'}
		>
