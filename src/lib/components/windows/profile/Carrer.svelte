<script lang="ts">
  ...
  export let carrer: any;

  export let isMobileVersion = false;

</script>

<div class="carrer-section" class:mobile={isMobileVersion}>
  ...
  <div class="timeline-container" class:mobile={isMobileVersion}>
    {#each carrer.steps as entry, index}
      <div class="timeline-item {index % 2 === 0 ? 'left' : 'right'}" class:mobile={isMobileVersion}>
        <div class="timeline-marker" class:mobile={isMobileVersion}>
          <div class="timeline-icon {entry.type === 'school' ? 'school' : 'work'}" class:mobile={isMobileVersion}>
            <Icon name={entry.type === 'school' ? 'school' : 'briefcase'} size="18" />
          </div>
        </div>
        <a href={entry.url} target="_blank" rel="noopener noreferrer" class="timeline-content-link" class:mobile={isMobileVersion}>
          <div class="timeline-content" class:mobile={isMobileVersion}>
            <div class="timeline-header" class:mobile={isMobileVersion}>
              ...
              <span class="timeline-date" class:mobile={isMobileVersion}>{entry.from} - {entry.to}</span>
            </div>
