<script lang="ts">
	...
	import type { Information as InformationData, Coordinates } from '$lib/types/data';
	export let information: InformationData;
	...
	function generateMapUrl(coordinates: Coordinates) {
				...
				<div class="info-grid" class:mobile={isMobileVersion}>
					...
					<div class="info-item" class:mobile={isMobileVersion}>
						...
						<div class="info-value">
							<a
								href={information.currentJob.url}
								target="_blank"
	...
	<div class="map-section">
		...
		<div class="map-container">
			<iframe
				title="Location"
				width="100%"
				height={isMobileVersion ? '300' : '600'}
				frameborder="0"
				scrolling="no"
				marginheight="0"
				marginwidth="0"
