<script lang="ts">
	...
	import Career from '$lib/components/windows/profile/Career.svelte';
		...
		<div class="modal-overlay">
			<div class="modal-container">
				...
				<div class="modal-footer">
					<button class="modal-button primary" on:click={closeWelcomeModal}
						>{$t('mobile.preferences.continue')}</button
					>
				</div>
			</div>
		</div>
